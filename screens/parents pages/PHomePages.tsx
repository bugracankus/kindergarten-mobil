      ...
      <SafeAreaView>
        ...
        <View style={styles.contentGround}>
          <VStack padding={5} space={5}>
            <Text style={styles.txt}>AYŞE BİNGÖL</Text>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("PEndDayScreen")}>
              <View style={styles.bttn}>
                <HStack style={{ alignItems: "center" }} space={7}>
                  <View>
                    <Image
            ...
            <TouchableOpacity onPress={() => navigation.navigate("PTeacherMessageScreen")}>
              <View style={styles.bttn}>
                <HStack style={{ alignItems: "center" }} space={7}>
                  <View>
                    <Image
                  ...
                  <View>
                    <Text style={styles.bttnTxt}>Öğretmene Mesaj</Text>
                  </View>
                </HStack>
              </View>
            </TouchableOpacity>
